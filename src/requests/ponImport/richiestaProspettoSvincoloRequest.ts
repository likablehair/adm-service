...
export default class RichiestaProspettoSvincoloRequest extends BaseRequest<RichiestaProspettoSvincolo> {
  constructor() {
    const superArgs = {
  ...
  async processRequest(
    ...
    try {
      ...
      return await this.asyncBaseProcessRequest({
        ...
        serviceId: 'richiestaProspettoSvincolo',
      });
    } catch (error: unknown) {
  ...
  protected createXMLForRequest(params: RichiestaProspettoSvincolo): string {
    return `
